...
object DrawerViews {
    ...
    internal val ICON_D_QUEUE = """<svg width="16" height="14" viewBox="0 0 16 14"><rect x="0" y="1" width="12" height="2" rx="1" fill="#3b3651"></rect><rect x="0" y="6" width="12" height="2" rx="1" fill="#3b3651"></rect><rect x="0" y="11" width="8" height="2" rx="1" fill="#3b3651"></rect></svg>"""
    ...
    internal val ICON_D_CLOCK = """<svg width="16" height="16" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6.5" stroke="#3b3651" stroke-width="1.5" fill="none"></circle><path d="M8 4.5 V8 L10.5 9.5" stroke="#3b3651" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"></path></svg>"""
    internal val ICON_D_HOURGLASS = """<svg width="16" height="16" viewBox="0 0 16 16"><path d="M4 1.5 H12 M4 14.5 H12 M5 1.5 V4 C5 6 8 7 8 8 C8 9 5 10 5 12 V14.5 M11 1.5 V4 C11 6 8 7 8 8 C8 9 11 10 11 12 V14.5" stroke="#3b3651" stroke-width="1.4" fill="none" stroke-linecap="round" stroke-linejoin="round"></path></svg>"""
